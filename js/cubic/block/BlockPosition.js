...
import { BLOCKS_PARAMS } from '../modules/index.js';
// import { BLOCKS_PARAMS } from '../modules/setupCubic.js';
export default class BlockPosition {
  ...
  rotate(rotateDirectionKey) {
    // 获取新位置的参数
    let newPositionKey = findKeyByValFromMultiMap(
      rotateDirectionKey,
      this.rotatablePositionMap
    );
  ...
  // 判断当前块是否在旋转层上
  isBlockInRotatingLayer(rotateFace) {
    let result = false;
